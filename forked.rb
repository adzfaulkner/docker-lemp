...
tomount = "/Library/WebServer/Documents"
bootlocalsh = %Q(#/bin/bash
sudo /usr/local/etc/init.d/nfs-client start
sudo mount -t nfs -o noacl,async <%= vboxnet_ip %>:/Library/WebServer/Documents /Library/WebServer/Documents
)
...
`echo '\n#{tomount} #{machine_ip} -alldirs -maproot=root\n' | sudo tee -a /etc/exports`
...
puts "Output should include something like this: '#{vboxnet_ip}:#{tomount} [...] #{tomount}'"
